...
{
    public class StitchGridMeshGenerator
    {
        public int radialRes = KnitSettings.radialRes;

        public StitchGridNodeType nodeType;

        public StitchGridMeshGenerator(StitchGridNodeType nodeType)
        {
        ...
        {
            StitchGridStitchCurve baseStitchCurve = StitchGridStitchCurve.GetStitchGridStitchCurve(
                nodeType,
                yarnWidth,
                rowIndex,
                loopIndexConsumed,
            ...
            Debug.Log($"Getting game object for {rowIndex}/{loopIndexConsumed}. Length(vertices)={vertices.Length}");
            ...
            )
        {
            ...
            /* To rotate the game object, can use the following
            // Commented out since currently not using
            ...
            */
            ...
            /*
            // Set local scale for game object; currently just set to 1
            // so commented out
